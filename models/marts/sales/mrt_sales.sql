...
(
    ...
    ,round((("Стоимость продаж"-"НДС продаж")/"EUR"*"EUR_scale")::numeric,2) as "Сумма продажи без НДС, EUR"
    ,round((("Стоимость продаж"-"НДС продаж")/"RUB"*"RUB_scale")::numeric,2) as "Сумма продажи без НДС, RUB"
    ,round((("Стоимость продаж"-"НДС продаж")/"USD"*"USD_scale")::numeric,2) as "Сумма продажи без НДС, USD"
    ,case 
        when alpha_3 is not null then alpha_3 
        else 'BLR'
    ...
    ,case
        when "Вид производства номенклат." = 'Давальческое' then 'Давальческое'
        when coalesce(alpha_3, 'BLR')  = 'BLR' then 'Беларусь'
    ...
    ,case 
        ...
        else round(("Срок годности серии ном." - "Период продаж")::numeric/("Срок годности серии ном."-"Дата производства серии ном.")::numeric,4) 
...
(
    ...
    WHERE 
        ...
        AND COALESCE("Наименование склада", '') NOT IN ('Витебск ГП (опытные партии)')
